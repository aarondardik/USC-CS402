...
bootstrap(int arg1, void *arg2)
{
    ...
    dbgq(DBG_TEST,
         "SIGNATURE: 53616c7465645f5f0cc6ab709af8eed456887b56b29ade3e58080de43d1bd0afb7d0c212c3af79856e28c8ff7bf3fa65\n");
...
idleproc_run(int arg1, void *arg2)
{
    ...
    dbg(DBG_PRINT, "Going to run do_mkdir for dev dir \n");
    do_mkdir("/dev");
...
int *create_sunghun_proc_deadlock()
{
...
{
    dbg(DBG_PRINT, "Going to test VFS main tests\n");
    KASSERT(kshell != NULL);
    proc_t *p = proc_create("vfstest");
    kthread_t *t = kthread_create(p, vfstest_main, 1, NULL);
    KASSERT(p && t && "Cannot create thread or process");
...
initproc_run(int arg1, void *arg2)
{
    ...
    kshell_add_command("fabertest", (kshell_cmd_func_t)create_faber_test_proc, "Running faber test");
    kshell_add_command("sh_test", (kshell_cmd_func_t)create_sunghun_proc, "Running sunghun test");
    kshell_add_command("sh_deadlock", (kshell_cmd_func_t)create_sunghun_proc_deadlock, "Running sunghun deadlock test");
    kshell_add_command("vfs_test", do_vfstest, "Running vfstest ");
    kshell_add_command("fs_test", faber_fs_thread_test, "Running faber_fs_thread_test ");
    kshell_add_command("dir_test", faber_directory_test, "Running faber_directory_test ");

...
If you have additional instruction for the grader, replace "(Comments?)" with your instruction (or with the word "none" if you don't have additional instructions):
    Additional instructions for building/running this assignment:

    # once you put the untarred files inside the proc directory, please go to weenix directory and then run "make" or
    # "make all" command. i.e. "cd weenix; make ;"
...
(A.3) In proc/kthread.c:
    ...
    (b) In kthread_cancel(): 2 out of 1 pt
...
(B) Kshell : 20 out of 20 pts
    What is your kshell command to invoke faber_thread_test(): fabertest
    What is your kshell command to invoke sunghan_test(): sh_test
    What is your kshell command to invoke sunghan_deadlock_test(): sh_deadlock
...
Aaron Dardik: dardik@usc.edu
Vignesh Selvaraj:  vs96005@udc.edu
Meghana Putta Swamy: mswamy@usc.edu
Kartik Hakim: kartikha@usc.edu
